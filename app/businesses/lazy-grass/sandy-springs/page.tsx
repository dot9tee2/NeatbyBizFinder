...
function JsonLd() {
  const json = {
    ...
    areaServed: [lazyGrass.serviceArea, 'Woodstock', 'Georgia'],
    url: 'https://nearbybizfinder.com/businesses/lazy-grass/sandy-springs/',
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:description" content="Expert artificial turf installation in Sandy Springs, GA. We handle grading, drainage, and professional installation." />
      </Head>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="pt-32 pb-20 px-4 relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            >
              <source src="/lazy-grass/sandy-springs/hero.mp4" type="video/mp4" />
            </video>
