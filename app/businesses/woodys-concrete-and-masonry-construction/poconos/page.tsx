...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: ['/woodys-concrete-and-masonry-construction/poconos/hero.webp'],
    url: SITE_URL,
    type: 'website',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-14 sm:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative h-80 sm:h-[420px] lg:h-[520px] rounded-2xl overflow-hidden border-2 border-[#2a4030]">
            <Image src="/woodys-concrete-and-masonry-construction/poconos/hero.webp" alt="Log cabin home in a snowy Pocono-style forest" fill priority quality={85} className="object-cover" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14">
          <div>
            ...
            <div className="relative h-56 sm:h-72 rounded-2xl overflow-hidden border border-[#2a4030]">
              <Image src="/woodys-concrete-and-masonry-construction/poconos/why-choose-us.webp" alt="Wooden home nestled in the mountains" fill quality={85} className="object-cover" />
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="relative h-72 sm:h-96 rounded-2xl overflow-hidden border border-[#2a4030] order-2 lg:order-1">
            <Image src="/woodys-concrete-and-masonry-construction/poconos/retaining-wall.webp" alt="Segmental concrete retaining wall on a wooded hillside" fill quality={85} className="object-cover" />
          </div>
      ...
      <div className="bg-[#16281c] py-16 sm:py-24 border-y border-[#2a4030]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {[
              { src: '/woodys-concrete-and-masonry-construction/poconos/excavation.webp', alt: 'Excavation on a wooded, sloped Pocono building site' },
              { src: '/woodys-concrete-and-masonry-construction/poconos/footing.webp', alt: 'Concrete footing formed on a sloped mountain lot' },
              { src: '/woodys-concrete-and-masonry-construction/poconos/porch.webp', alt: 'Stone and timber porch with concrete steps' },
              { src: '/woodys-concrete-and-masonry-construction/poconos/patio.webp', alt: 'Concrete patio behind a mountain cabin' },
              { src: '/woodys-concrete-and-masonry-construction/poconos/driveway.webp', alt: 'Driveway and foundation work at a mountain home' },
              { src: '/woodys-concrete-and-masonry-construction/poconos/hillside-wall.webp', alt: 'Terraced hillside retaining wall system' },
            ].map((img, i) => (
