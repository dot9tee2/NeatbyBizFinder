...
export const businessData: Record<string, BusinessLandingData> = {
  ...
  'nm-concrete-coating-pros': {
    ...
    featuredImage: 'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
    description: 'Professional epoxy floor coating, metallic resin, polyaspartic coating, and concrete polishing services. Over a decade of experience serving New Mexico.',
    hours: {
    ...
    amenities: ['Licensed & Insured', 'Over 10 Years Experience', 'Lifetime Warranty', 'Free Estimates', 'Residential & Commercial'],
    images: [
      'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
      'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
    ],
...
export const locationData: Record<string, Record<string, LocationData>> = {
  ...
  'nm-concrete-coating-pros': {
    'santa-fe': {
      ...
      parentBusiness: 'nm-concrete-coating-pros',
      category: 'Concrete Coating Services',
      rating: 4.8,
      reviewCount: 89,
      priceRange: '$$$',
    ...
    'rio-rancho': {
      ...
      amenities: ['Licensed & Insured', 'Over 10 Years Experience', 'Lifetime Warranty', 'Free Estimates', 'Luxury Services'],
      images: [
        'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
        'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
      ],
    ...
    'los-lunas': {
      ...
      amenities: ['Licensed & Insured', 'Over 10 Years Experience', 'Lifetime Warranty', 'Free Estimates', 'Family Safe'],
      images: [
        'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
        'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
      ],
    ...
    'edgewood': {
      ...
      amenities: ['Licensed & Insured', 'Over 10 Years Experience', 'Lifetime Warranty', 'Free Estimates', 'Mountain Tested'],
      images: [
        'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
        'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg',
      ],
