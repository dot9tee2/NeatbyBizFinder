          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center space-x-3">
                ...
                <a href={`tel:${businessPhone}`} className="text-gray-400 hover:text-white transition-colors">
                  {businessPhone}
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-4 w-4 text-gray-400" />
                <a href={`mailto:${businessEmail}`} className="text-gray-400 hover:text-white transition-colors">
                  {businessEmail}
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Globe className="h-4 w-4 text-gray-400" />
                <a href={businessWebsite} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  Visit Our Website
                </a>
              </li>
              {businessAddress && (
